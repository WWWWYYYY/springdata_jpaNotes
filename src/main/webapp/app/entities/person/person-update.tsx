    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="springdataJpaNotesApp.person.home.createOrEditLabel">Create or edit a Person</h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : personEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvField id="person-sex" type="string" className="form-control" name="sex" />
                </AvGroup>
                <AvGroup>
                  <Label id="addrLabel" for="addr">
                    Addr
                  </Label>
                  <AvField id="person-addr" type="text" name="addr" />
                </AvGroup>
                <AvGroup>
                  <Label id="highLabel" for="high">
                    High
                  </Label>
                  <AvField id="person-high" type="string" className="form-control" name="high" />
                </AvGroup>
                <AvGroup>
